...
function display() {
    ...
    let html2 = `<h2>${magic2.name}</h2>` + `<h3>${magic2.color}</h3>` + `<img src=${magic2.img}>` +
    `<h3></h3>` + `<p>${magic2.cost}</p>` + `<p>${magic2.type}</p>` + `<p>${magic2.use}</p>`;

    let html3 = `<h2>${magic3.name}</h2>` + `<h3>${magic3.color}</h3>` + `<img src=${magic3.img}>` +
    `<h3></h3>` + `<p>${magic3.cost}</p>` + `<p>${magic3.type}</p>` + `<p>${magic3.use}</p>`;

    let html4 = `<h2>${magic4.name}</h2>` + `<h3>${magic4.color}</h3>` + `<img src=${magic4.img}>` +
    `<h3></h3>` + `<p>${magic4.cost}</p>` + `<p>${magic4.type}</p>` + `<p>${magic4.use}</p>`;

    let html5 = `<h2>${magic5.name}</h2>` + `<h3>${magic5.color}</h3>` + `<img src=${magic5.img}>` +
    `<h3></h3>` + `<p>${magic5.cost}</p>` + `<p>${magic5.type}</p>` + `<p>${magic5.use}</p>`;
